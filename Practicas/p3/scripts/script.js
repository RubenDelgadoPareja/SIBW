...
function censura() {
    const PROHIBIR = '*'
    var INSULTOS = document.getElementById("censura").value.match(/[a-z'\-]+/gi)
    console.log(INSULTOS)
...
function anterior() {
    ...
    document.getElementById("aspectos").src = '/images/'+galeria[posicion]+'.jpg'

}

function siguiente() {
    var galeria = document.getElementById("galeria").value.match(/[a-z'\-]+/gi)
    posicion = (posicion + 1) % galeria.length
